...
func TestBatchTxCheckpoint(t *testing.T) {
	...
	var (
		tokenId   uint64 = 1
		tokenAddr        = "0x835973768750b3ED2D5c3EF5AdcD5eDb44d12aD4"
	)

	src := BatchTx{
		BatchNonce: 1,
		Timeout:    2111,
		Transactions: []*SendToExternal{
			{
				Id:                0x1,
				Sender:            senderAddr.String(),
				ExternalRecipient: "0x9FC9C2DfBA3b6cF204C37a5F690619772b926e39",
				Token:             NewSDKIntExternalToken(sdk.NewInt(0x1), tokenId, tokenAddr),
				Fee:               NewSDKIntExternalToken(sdk.NewInt(0x1), tokenId, tokenAddr),
			},
		},
		ExternalTokenId: tokenAddr,
	}
...
func TestContractCallTxCheckpoint(t *testing.T) {
	...
	token := []ExternalToken{NewSDKIntExternalToken(sdk.NewIntFromUint64(1), 1, "0xC26eFfa98B8A2632141562Ae7E34953Cfe5B4888")}
	call := ContractCallTx{
		Tokens:            token,
		Fees:              token,
...
func TestValsetCheckpoint(t *testing.T) {
	src := NewSignerSetTx(0xc, 0xc, ExternalSigners{{
		Power:           0xffffffff,
		ExternalAddress: gethcommon.Address{0xb4, 0x62, 0x86, 0x4e, 0x39, 0x5d, 0x88, 0xd6, 0xbc, 0x7c, 0x5d, 0xd5, 0xf3, 0xf5, 0xeb, 0x4c, 0xc2, 0x59, 0x92, 0x55}.String(),
	}})

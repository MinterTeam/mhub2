...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	cdc.RegisterConcrete(&MsgDelegateKeys{}, "mhub2-bridge/", nil)
}
...
func RegisterInterfaces(registry types.InterfaceRegistry) {
	...
	registry.RegisterInterface(
		"mhub2.v1.ExternalEvent",
		(*ExternalEvent)(nil),
		&SendToHubEvent{},
		&TransferToChainEvent{},
		&BatchExecutedEvent{},
	...
	registry.RegisterInterface(
		"mhub2.v1.ExternalSignature",
		(*ExternalTxConfirmation)(nil),
		&BatchTxConfirmation{},
...
// UnpackEvent unpacks an Any into an ExternalEvent. It returns an error if the
...
func UnpackEvent(any *types.Any) (ExternalEvent, error) {
	...
	event, ok := any.GetCachedValue().(ExternalEvent)
	if !ok {
		return nil, sdkerrors.Wrapf(sdkerrors.ErrUnpackAny, "cannot unpack Any into ExternalEvent %T", any)
	}
...
func UnpackConfirmation(any *types.Any) (ExternalTxConfirmation, error) {
	...
	confirm, ok := any.GetCachedValue().(ExternalTxConfirmation)
	if !ok {

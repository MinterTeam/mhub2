		...
		TokenInfos: []*TokenInfo{
			{
				...
				Denom:            "hub",
				ChainId:          "ethereum",
				ExternalTokenId:  "0xce8223acbf08B85EAf2354cD86104BA38bD0e3f6",
				ExternalDecimals: 18,
			...
			},
			{
				...
				Denom:            "eth",
				ChainId:          "ethereum",
				ExternalTokenId:  "0x7b79995e5f793A07Bc00c21412e50Ecae098E7f9",
				ExternalDecimals: 18,
				Commission:       sdk.NewDec(1).QuoInt64(100),
			},
			{
			...
			},
			{
				...
				Denom:            "metagarden",
				ChainId:          "metagarden",
				ExternalTokenId:  "0xcD58EAAe6F88e21843c77D45AFD68914953e5aCC",
				ExternalDecimals: 18,
				Commission:       sdk.NewDec(1).QuoInt64(100),
			},
			{
			...
			},
			{
				...
				Denom:            "bnb",
				ChainId:          "bsc",
				ExternalTokenId:  "0x2A416168ceA12820E288d36f77C1b7f936F4e228",
				ExternalDecimals: 18,
				Commission:       sdk.NewDec(1).QuoInt64(100),
			},
		},

...
func NewMhub2App(
	...
	app.mhub2Keeper = mhub2Keeper.SetStakingKeeper(app.stakingKeeper)
	...
	app.upgradeKeeper.SetUpgradeHandler("v0.2.2", func(ctx sdk.Context, plan upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {

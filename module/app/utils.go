...
func SimulationOperations(app Mhub2, cdc codec.JSONCodec, config simtypes.Config) []simtypes.WeightedOperation {
...
func CheckExportSimulation(
	app Mhub2, config simtypes.Config, params simtypes.Params,
) error {

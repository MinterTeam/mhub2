...
impl ValsetConfirmResponse {
    pub fn from_proto(
        input: mhub2_proto::mhub2::SignerSetTxConfirmation,
    ) -> Result<Self, GravityError> {
        Ok(ValsetConfirmResponse {
            eth_signer: input.external_signer.parse()?,
...
impl From<mhub2_proto::mhub2::SignerSetTxResponse> for Valset {
    fn from(input: mhub2_proto::mhub2::SignerSetTxResponse) -> Self {
        Valset {
...
impl From<mhub2_proto::mhub2::SignerSetTx> for Valset {
    fn from(input: mhub2_proto::mhub2::SignerSetTx) -> Self {
        Valset {
...
impl From<mhub2_proto::mhub2::ExternalSigner> for ValsetMember {
    fn from(input: mhub2_proto::mhub2::ExternalSigner) -> Self {
        let eth_address = match input.external_address.parse() {
            Ok(e) => Some(e),
            Err(_) => None,
        };
        ValsetMember {
...
impl From<&ValsetMember> for mhub2_proto::mhub2::ExternalSigner {
    fn from(input: &ValsetMember) -> mhub2_proto::mhub2::ExternalSigner {
        let external_address = match input.eth_address {
            Some(e) => e.to_string(),
            None => String::new(),
        };
        mhub2_proto::mhub2::ExternalSigner {
            power: input.power,
            external_address,
        }
    }
